...
public class SettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        Checkbox enableWarningBox = Checkbox
                ...
                .onValueChange((checkbox, message) -> ClientConfig.INSTANCE.enableWarning.set(checkbox.selected()))
                .build();
        this.addRenderableWidget(enableWarningBox);

        int currentThreshold = ClientConfig.INSTANCE.warningThreshold.get();
        this.addRenderableWidget(new AbstractSliderButton(centerX - 100, centerY - 10, 200, 20,
